...
def evaluate_model(model_path, threshold=0.4):
    ...
    # 打印指标摘要
    print_metrics_summary(metrics, "Inception_v3模型评估结果")
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='Inception_v3模型评估和可视化')
    ...
    if args.model is None:
        ...
        model_files = glob.glob(os.path.join(model_dir, "inception_v3_best_epoch*.pth"))
        if model_files:
            # 按epoch编号排序，选择最新的
